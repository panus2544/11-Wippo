...
export const Stats = {
    getRegistrantStats: async () => {
        ...
        return await apiRegService.get('/stats/registrants');
    },
    getRegistrantStatsByDate: async (startdate,enddate) => {
        return await apiRegService.get('/stats/registrants/date?startdate='+startdate+"&&enddate="+enddate);
    },
    getRegistrantStatsByTime: async () => {
        return await apiRegService.get('/stats/registrants/time');
    }
